...
class BEAConnector(BaseConnector):
    ...
    def __init__(self, api_key: Optional[str] = None, cache_dir: Optional[str] = None):
        ...
        if not self.api_key:
            raise ValueError("BEA API key is required. Register at https://apps.bea.gov/api/signup/")
    ...
    def fetch(self, **kwargs: Any) -> pd.DataFrame:
        ...
        if dataset == 'nipa':
            ...
            raise ValueError(f"Invalid dataset: {dataset}. Must be 'nipa', 'regional', 'gdpindustry', or 'fixedassets'")
