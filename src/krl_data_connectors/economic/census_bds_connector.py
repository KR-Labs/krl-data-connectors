...
class CensusBDSConnector(BaseConnector):
    ...
    def get_startup_rates(
        ...
        if geography == 'national':
            ...
            data = pd.DataFrame(states, columns=[
                'geography_name', 'geography_code', 'establishments_total',
                'establishments_births', 'startup_rate', 'employment_births',
                'avg_size_births'
            ])
            data['year'] = year
            ...
            data = pd.DataFrame(msas, columns=[
                'geography_name', 'geography_code', 'establishments_total',
                'establishments_births', 'startup_rate', 'employment_births',
                'avg_size_births'
            ])
    ...
    def analyze_job_creation(
        ...
        """
        logger.info(
            "Analyzing job creation: state=%s, years=%d-%d",
    ...
    def get_firm_age_distribution(
        ...
        if geography == 'national':
            ...
            data = pd.DataFrame(states, columns=[
                'geography_name', 'geography_code', 'age_0', 'age_1_to_5',
                'age_6_to_10', 'age_11_plus', 'total_firms', 'pct_young', 'avg_age'
            ])
            data['year'] = year
    ...
    def get_firm_size_distribution(
        ...
        if geography == 'national':
            ...
            states = [
                ('California', '06', 528_000, 176_000, 88_000, 70_400, 14_080, 3_520, 880_000, 90.0),
                ...
                ('Pennsylvania', '42', 162_000, 54_000, 27_000, 21_600, 4_320, 1_080, 270_000, 90.0),
            ]
            
            data = pd.DataFrame(states, columns=[
                'geography_name', 'geography_code', 'size_1_to_4', 'size_5_to_9',
                'size_10_to_19', 'size_20_to_99', 'size_100_to_499', 'size_500_plus',
    ...
    def calculate_survival_rates(
        ...
        logger.info(
            ...
            cohort_year, years_tracked, geography
        )
    ...
    def compare_economic_dynamism(
        ...
        """
        logger.info(
            "Comparing economic dynamism: year=%d, %d geographies",
            year, len(geographies)
        )
    ...
    def get_sector_dynamics(
        ...
        """
        logger.info(
            "Fetching sector dynamics: year=%d, sector=%s, geography=%s",
            year, sector, geography
        )
