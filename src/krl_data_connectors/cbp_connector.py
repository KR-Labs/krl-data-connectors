...
class CountyBusinessPatternsConnector(BaseConnector):
    ...
    def fetch(self, **kwargs: Any) -> pd.DataFrame:
        ...
        if geography == 'county':
            ...
            raise ValueError(f"Invalid geography: {geography}. Must be 'county', 'state', or 'metro'")
    ...
    def get_metro_data(
        ...
        params = {
            'get': ','.join(variables),
            'for': f'metropolitan statistical area/micropolitan statistical area:{metro}' if metro else 'metropolitan statistical area/micropolitan statistical area:*',
        }
