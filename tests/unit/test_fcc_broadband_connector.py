...
class TestFCCBroadbandConnectorContracts:
    ...
    def test_load_coverage_data_return_type(self, connector, tmp_path):
        ...
        expected_columns = [
            'state_abbr', 'county_geoid', 'block_geoid', 'provider_id',
            'technology', 'max_down', 'max_up', 'low_latency'
        ]
    ...
    def test_get_provider_competition_return_type(self, connector, tmp_path):
        ...
        assert monopoly_block['monopoly'] == True, "Should flag monopoly"
        ...
        assert duopoly_block['duopoly'] == True, "Should flag duopoly"
        ...
        assert competitive_block['competitive'] == True, "Should flag competitive"
