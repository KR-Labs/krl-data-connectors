...
def test_find_treatment_facilities_return_type(samhsa_connector):
    ...
    """
    facilities = samhsa_connector.find_treatment_facilities(
        state='CA',
        city='Los Angeles'
    )
    ...
    expected_columns = [
        ...
        'phone', 'website', 'facility_type', 'services_offered',
        'has_medication_assisted_treatment', 'accepts_opioid_clients',
        'payment_accepted', 'special_programs', 'capacity'
    ]
...
def test_get_facilities_by_state_return_type(samhsa_connector):
    ...
    assert all(
        'Substance Abuse' in services 
        for services in facilities['services_offered']
    )
...
def test_get_substance_services_return_type(samhsa_connector):
    ...
    mat_facilities = samhsa_connector.get_substance_services(
        state='CA',
...
def test_get_mental_health_services_return_type(samhsa_connector):
    ...
    assert all(
        'Veterans' in programs 
        for programs in vet_facilities['special_programs']
    )
...
def test_get_facility_statistics_return_type(samhsa_connector):
    ...
    # Should have expected columns
    expected_columns = [
        'state', 'total_facilities', 'substance_abuse_facilities',
        'mental_health_facilities', 'mat_facilities',
        'residential_facilities', 'outpatient_facilities',
    ...
    count_cols = [
        'total_facilities', 'substance_abuse_facilities',
        'mental_health_facilities', 'mat_facilities'
    ]
...
def test_analyze_service_gaps_return_type(samhsa_connector):
    ...
    # Should have expected columns
    expected_columns = [
        'county', 'total_facilities', 'total_capacity',
        'mat_facilities', 'service_gap_indicator'
    ]
    for col in expected_columns:
    ...
    gaps_with_pop = samhsa_connector.analyze_service_gaps(
        state='FL',
...
def test_fetch_method_routing(samhsa_connector):
    ...
    facilities = samhsa_connector.fetch(
    ...
    substance = samhsa_connector.fetch(
        query_type='substance_abuse',
        state='NY'
    )
