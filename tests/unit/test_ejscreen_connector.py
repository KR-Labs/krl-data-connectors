...
def sample_ejscreen_data():
    ...
    return pd.DataFrame({
        'ID': [
            '010010201001', '010010201002', '010010202001',
            '440070401001', '440070401002', '440070402001',
            '060370101001', '060370101002', '060370102001'
        ],
        'ST_ABBREV': ['AL', 'AL', 'AL', 'RI', 'RI', 'RI', 'CA', 'CA', 'CA'],
        'CNTY_FIPS': ['01001', '01001', '01001', '44007', '44007', '44007', '06037', '06037', '06037'],
...
class TestGetCountyData:
    ...
    def test_get_county_data_invalid_column(self, ejscreen_connector, sample_ejscreen_data):
        ...
        with pytest.raises(ValueError, match="County FIPS column"):
            ejscreen_connector.get_county_data(
                sample_ejscreen_data, '44007', fips_column='INVALID'
            )
...
class TestSummarizeByState:
    ...
    def test_summarize_by_state_multiple_indicators(
        self, ejscreen_connector, sample_ejscreen_data
    ):
