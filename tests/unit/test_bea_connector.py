            ...
            'BEAAPI': {
                'Results': {
                    'Dataset': [
                        ...
                        {'DatasetName': 'NIUnderlyingDetail', 'DatasetDescription': 'NIPA Underlying Detail'},
    ...
    def mock_parameter_list_response(self):
        ...
        return {
            'BEAAPI': {
                'Results': {
                    'Parameter': [
                        {'ParameterName': 'Frequency', 'ParameterDescription': 'A=Annual, Q=Quarterly'},
...
class TestBEACaching:
    ...
    def test_caching_enabled(self, mock_request, temp_cache_dir):
        ...
        mock_response = {
            'BEAAPI': {
                'Results': {
                    'Data': [{'DataValue': '100', 'TimePeriod': '2023'}]
                }
            }
        }
