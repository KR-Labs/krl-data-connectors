...
class TestMITElectionLabConnectorContracts:
    ...
    def sample_presidential_data(self, tmp_path):
        ...
        csv_path.write_text(
            ...
            "candidate,party_detailed,party_simplified,mode,"
            "candidatevotes,totalvotes,writein,version\n"
            "2020,Pennsylvania,PA,42,23,62,PRESIDENT,Joe Biden,"
            "DEMOCRAT,DEMOCRAT,total,3458229,6915283,FALSE,20210113\n"
            "2020,Pennsylvania,PA,42,23,62,PRESIDENT,Donald Trump,"
            "REPUBLICAN,REPUBLICAN,total,3377674,6915283,FALSE,20210113\n"
            "2020,Pennsylvania,PA,42,23,62,PRESIDENT,Jo Jorgensen,"
            "LIBERTARIAN,OTHER,total,79380,6915283,FALSE,20210113\n"
            "2020,Georgia,GA,13,58,31,PRESIDENT,Joe Biden,"
            "DEMOCRAT,DEMOCRAT,total,2473633,4999960,FALSE,20210113\n"
            "2020,Georgia,GA,13,58,31,PRESIDENT,Donald Trump,"
            "REPUBLICAN,REPUBLICAN,total,2461854,4999960,FALSE,20210113\n"
            "2020,Georgia,GA,13,58,31,PRESIDENT,Jo Jorgensen,"
            "LIBERTARIAN,OTHER,total,62229,4999960,FALSE,20210113\n"
            "2016,Pennsylvania,PA,42,23,62,PRESIDENT,Hillary Clinton,"
            "DEMOCRAT,DEMOCRAT,total,2926441,6165478,FALSE,20210113\n"
            "2016,Pennsylvania,PA,42,23,62,PRESIDENT,Donald Trump,"
            "REPUBLICAN,REPUBLICAN,total,2970733,6165478,FALSE,20210113\n"
        )
        return csv_path
    ...
    def test_load_presidential_data_return_type(self, connector, sample_presidential_data):
        """
    ...
    def test_load_county_presidential_data_return_type(self, connector, sample_county_data):
        """
    ...
    def test_get_election_results_return_type(self, connector, sample_presidential_data):
        """
    ...
    def test_get_state_winner_return_type(self, connector, sample_presidential_data):
        """
    ...
    def test_get_swing_states_return_type(self, connector, sample_presidential_data):
        """
    ...
    def test_get_state_trends_return_type(self, connector, sample_presidential_data):
        """
