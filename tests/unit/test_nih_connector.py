...
class TestNIHConnectorGetFundingTrends:
    ...
    def test_get_funding_trends(self, nih_connector):
        ...
        mock_response = {
            'results': [{
                'ProjectNum': '1R01CA123484',
                'FiscalYear': 2020,
                'AwardAmount': 600000
            }, {
                'ProjectNum': '1R01CA123485',
                'FiscalYear': 2021,
                'AwardAmount': 650000
            }]
        }
